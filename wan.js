...
////< DAFTAR BUTTON BY follow @eghinuphorapira > ////
...
menu =`${botName}
 ...
 Selamat Datang Di Menu ArixaBotz 
...
Flw: instagram.com/eghinuphorapira/ `
...
▹ ${prefix}wallgravity text1 text2
 ...
 `
  ...
  sendButMessage(from, wibu, `created follow @eghinuphorapira`, [
...
reply('1 untuk mengaktifkan, 0 untuk menonaktifkan')
 ...
 buttonsMessage = {footerText:'follow @eghinuphorapira', imageMessage: imageMsg,
...
▹ ${prefix}bokep25
 ...
 sendButMessage(from, menu, `created follow @eghinuphorapira`, [
...
setTimeout( () => {
 ...
 fakestatus(` *Terimakasih Telah Terdaftar Di Database Arixa Botz* `)
...
Silahkan Dipilih Kak😇
  ...
  ┃⬡ https://instabio.cc/eghinuphorapira
  ┗━━⬣
  `
...
${time2} WIB`
 ...
 Wa.me/6285640068416`
 sendButMessage(from, titid, `follow @eghinuphorapira `, [
 {
...
"jpegThumbnail": fakeimage
 ...
 "businessOwnerJid": sender
  ...
  "footerText": "\nPowered follow @eghinuphorapira. "
...
footerText: 'Im Arixa Botz Sudah On ',
...
reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/eghinuphorapira/`)
...
reply('https://instabio.cc/eghinuphoraphira')
